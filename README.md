...
## 이 Repository는 실시간 커머스 플랫폼 교육과정에서 생성한 프로젝트의 개인적인 개선 버전을 위해 만들었습니다.
### 개선 목적
1. 웹훅 핸들러 적용을 통한 결제 프로세스(ex. 검증) 실시간성 및 데이터 정합성 보장
2. AWS 서비스를 제외하여 비용 절감 목적의 배포 마이그레이션 - Github Pages 기능 시도
3. (마이그레이션 완료 후)CI/CD 파이프라인 수정
